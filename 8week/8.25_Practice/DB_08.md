...
```python
director_1 = Director.objects.get(name='김한민')
director_2 = Director.objects.get(name='최동훈')
director_3 = Director.objects.get(name='이정재')
director_4 = Director.objects.get(name='이경규')
director_5 = Director.objects.get(name='한재림')
director_6 = Director.objects.get(name='Joseph Kosinski')

genre_1 = Genre.objects.get(title='SF')
genre_2 = Genre.objects.get(title='사극')
genre_3 = Genre.objects.get(title='첩보')
genre_4 = Genre.objects.get(title='액션')
genre_5 = Genre.objects.get(title='재난')

movies = [
    (director_, genre_, "괴물", "2006-07-27", 119, False),
    (director_, genre_1, "설국열차", "2013-10-30", 125, False),
    (director_1, genre_2, "한산", "2022-07-27", 129, True),
    (director_2, genre_1, "외계+인", "2022-07-20", 142, False),
    (director_3, genre_3, "헌트", "2022-08-10", 125, True),
    (director_4, genre_4, "복수혈전", "1992-10-10", 88, False),
    (director_5, genre_5, "비상선언", "2022-08-03", 140, True),
    (director_6, genre_4, "탑건 : 매버릭", "2022-06-22", 130, True),
]
...
```python
movies_1 = Movie.objects.filter(screening = 'True').order_by('opening_date')
...
movie = Movie.objects.filter(director = name).order_by('opening_date')
...
```python
name = Director.objects.get(name='봉준호')
movie = Movie.objects.filter(director = name).order_by('opening_date')[1]
...
```python
name_ = Director.objects.get(name='봉준호')
genre_ = Genre.objects.get(title='드라마')
movies = Movie.objects.filter(director=name_, genre=genre_).order_by('opening_date')
...
```python
name = Director.objects.get(name='봉준호')
movies = Movie.objects.exclude(director = name).order_by('opening_date')
